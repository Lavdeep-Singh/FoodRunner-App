    ...
    ) : RecyclerView.Adapter<OrderHistoryAdapter.ViewHolderOrderHistoryRestaurant>()
    {
        ...
        override fun onCreateViewHolder(
            ...
            val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.oredr_history_recycler_view_single_row, parent, false)
            ...
            if (ConnectionManager().checkConnectivity(context)) {
                ...
                try {
                    ...
                    val sharedPreferences = context.getSharedPreferences(
                        context.getString(R.string.reg_user_id),
                    ...
                    val jsonObjectRequest = object : JsonObjectRequest(
                        ...
                        Response.Listener {
                            ...
                            if (success) {
                                ...
                                val foodOrdered =
                                    restaurantObjectRetrieved.getJSONArray("food_items")
